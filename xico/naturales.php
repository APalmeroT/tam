            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">El río Guayalejo</h2>
                        <p class="descripcion-atraccion">El río Guayalejo cruza el municipio de noreste a suroeste, dirigiendo su escurrimiento hacia el río pánuco. Además cuenta con la presa Xicoténcatl ubicada en la región noroeste del municipio, además de la presa Emilio Portes Gil, mismas que son alimentadas por el río Guayalejo.</p>
                        <center>
                        <img src="../../img/Guaya.jpg" alt="" class="featured__img">
        </center>  
                    </div>
                </div>
            </section>
