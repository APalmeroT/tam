            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">Aniversario de Palmillas</h2>
                        <p class="descripcion-atraccion">El 02 de agisto  de cada año, se realizan las festividades para conmemorar la fundación de Palmillas. </p>
                        <center>
                        <img src="../../img/Palmillas-Eventos.jpg" alt="" class="featured__img">
        </center>  
                    </div>
                </div>
            </section>
