        ...
        ?>
            ...
            <section class="">
                <div class="container">
                    ...
                    <h2 class="section-title1">Guemez</h2>
                    <h3 class="section-title2">Atracciones turísticas</h3>
                    <div class="split">
                        <a href="http://167.71.185.28/municipios/guemez/naturales.php" class="featured__item">
                            <img src="http://167.71.185.28/img/atracciones_naturales.jpg" alt="" class="featured__img">
                            <p class=""><span class="price">Naturales</span></p>
                        </a>
                        <a href="http://167.71.185.28/municipios/guemez/patrimoniales.php" class="featured__item">
                ...
                <div class="container">
                    <div class="split">
                        <a href="http://167.71.185.28/municipios/guemez/eventos.php" class="featured__item">
                            <img src="http://167.71.185.28/img/atracciones_eventos.png" alt="" class="featured__img">
                            <p class=""><span class="price">Eventos</span></p>
                        </a>
                        <a href="http://167.71.185.28/municipios/guemez/parques.php" class="featured__item">
