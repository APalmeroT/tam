            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">Aniversario de santo patrono, San Antonio de Padua.</h2>
                        <p class="descripcion-atraccion">13 de junio se celebran las fiestas en honor del santo patrono, San Antonio de Padua.</p>
                        <center>
                        <img src="../../img/Padilla-Eventos.jpg" alt="" class="featured__img">
        </center>  
                    </div>
                </div>
            </section>
