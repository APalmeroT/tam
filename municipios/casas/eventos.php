            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <p class="descripcion-atraccion" style="text-aling:center">El 3 de junio de 1770, fecha de fundación.</p>
                        <center>
                        <img src="https://www.tamaulipas.gob.mx/wp-content/uploads/2016/09/casas17-800x500.jpg">
                     </center>
                        <h2 class="titulo-atraccion">Nombramiento</h2>
                        <p class="descripcion-atraccion"style="text-aling:center">Se le asigna el nombre de Casas en honor de Juan Bautista de las Casas, insigne insurgente en 1827.</p>
                        
                        <center>
                        <img src="https://www.tamaulipas.gob.mx/wp-content/uploads/2016/09/casas01-800x500.jpg">
                     </center>
                    </div>
                </div>
            </section>
