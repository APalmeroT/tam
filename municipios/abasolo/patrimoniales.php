            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <p class="descripcion-atraccion"style="text-align: justify;">Situada en el edificio del ayuntamiento, perteneciente al "Instituto Tamaulipeco para la Cultura y las Artes", ubicado en la calle Lázaro Cárdenas esq. Juárez, Col. Centro, CP. 87760, Abasolo, Tamaulipas.</p>
                        <center>
                        <img src= "https://upload.wikimedia.org/wikipedia/commons/2/24/Plaza_C%C3%ADvica_en_Abasolo%2C_Tamaulipas.jpg">
                        </center>
                        <h2 class="titulo-atraccion">Parroquia de Nuestra Señora del Rosario</h2>

                        <p class="descripcion-atraccion" style="text-align: justify;">Construida a fines del siglo XVIII y principios de XIX, se trata de una edificación que ha estado en la ciudad desde sus inicios y se ha mantenido como uno de los centros religiosos más importantes de la región.</p>
