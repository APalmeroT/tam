            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">Plaza Hidalgo</h2>
                        <p class="descripcion-atraccion" style="text-align: justify;">Apartado de la ciudad, a 25 minutos de la ciudad de Abasolo y  como parte del Rio Soto la marina, la cascada del porvenir cuenta con amplios cuerpos de agua tranquila y transparente, rodeado de árboles  que brindan sombra en un día soleado , además de tener kioscos para instalarse cómodamente, perfecto para pasar un dia en familia.</p></p>
                        <center>
                        <img src= https://upload.wikimedia.org/wikipedia/commons/2/28/Plaza_Principal_en_Hidalgo%2C_Tamaulipas.jpg>
                        </center>
                    </div>
                </div>
            </section>
