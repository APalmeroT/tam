...
<head>
    ...
    <title>Tamaholipa - El Mante</title>
</head>
<body>
                ...
                <div class="container">
                    <div class="split">
                        <a href="eventos.php" class="featured__item">
                            <img src="img/atracciones_eventos.png" alt="" class="featured__img">
                            <p class=""><span class="price">Eventos</span></p>
                        </a>
                        <a href="parques.php" class="featured__item">
                            <img src="img/atracciones_parques.jpg" alt="" class="featured__img">
