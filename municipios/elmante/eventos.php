            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">Nombramiento de la ciudad. </h2>
                        <p class="descripcion-atraccion">El 28 de Octubre de 1937 es elevada a la categoría de ciudad con el nombre de Ciudad Mante</p>
                        <center>
                        <img src="../../img/elmante/nombramiento.png" alt="" class="featured__img">
        </center>  
                    </div>
                </div>
            </section>
