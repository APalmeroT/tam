            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <p class="descripcion-atraccion" style="text-aling: justify">Tiene como atracciones naturales el río Tamesí, sirviendo de límite con el Estado de Veracruz. Se encuentra una presa llamada Ramiro Caballero, con una capacidad útil de 508 millones de metros cúbicos. Existen también las llamadas lagunas del sur y los arroyos de corriente intermitente como el Cojo, San Vicente, el Comedor, el Estero y el Verde. También se cuenta con la presa San Lorenzo y Venustiano Carranza</p>
                        <center>
