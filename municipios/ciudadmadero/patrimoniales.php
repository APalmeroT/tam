            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">Catedral</h2>
                        <p class="descripcion-atraccion">La Santa Iglesia Catedral de Tampico,dedicada a la Inmaculada Concepción de Santísima Virgen María, es el principal templo católico de la Diócesis de Tampico. Está ubicado frente a la Plaza de Armas, en el Centro Histórico de la ciudad, siendo el principal centro de culto cristiano de la Diócesis de Tampico (en latín: Dioecesis Tampicensis), sede episcopal de la Iglesia católica en México, integrada por once municipios de la parte meridional del estado de Tamaulipas</p>
                        <center>
                        <img src="https://i2.wp.com/granturismomexico.com/wp-content/uploads/2017/06/catedral-de-tampico.jpg?fit=1024%2C773&ssl=1">
                    </center>
                    </div>
                </div>
            </section>
