            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">Plaza Municipal</h2>
                        <p class="descripcion-atraccion"style="text-align: justify;">La plaza Municipal se encuentra en Municipio de Aldama. Esta empresa se desempeña en la siguiente industria: Casas, cabañas y complejos turísticos.</p>
                        <center>
                        <img src="https://mapio.net/images-p/24157334.jpg" >
                        </center>
                    </div>
                </div>
            </section>
