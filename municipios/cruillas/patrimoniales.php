            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">Casa de Juan José de la Garza</h2>
                        <p class="descripcion-atraccion">Casa donde nació Juan José de la Garza, ubicada en la calle del mismo nombre; Iglesia de Nuestra Señora de Monserrat construida en el siglo XVIII.</p>
                        <center>
                        <img src="https://upload.wikimedia.org/wikipedia/commons/0/0a/Iglesia_de_Cruillas%2C_Tamaulipas.jpg" >
        </center>
                    </div>
                </div>
            </section>
