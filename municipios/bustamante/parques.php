...
<head>
    ...
    <title>Tamaholipa - Bustamente</title>
</head>
<body>
            ...
            <section>
                <div class="container ventas titulo-recomendados" id="scrollear">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">Plaza Cívica</h2>
                        <p class="descripcion-atraccion" style="text-aling: center">Este lugar es muy agradable para pasar las tardes en familia, adecuado para tomar fotos.</p>
                       <center>
                        <img src="https://www.tamaulipas.gob.mx/wp-content/uploads/2016/09/bustamante02-800x500.jpg">
                      </center>
                    </div>
                </div>
            </section>
