            ...
            <section>
                <div class="container ventas titulo-recomendados">
                    ...
                    <div class="info-atracciones">
                        ...
                        <h2 class="titulo-atraccion">Parque Cultural Reynosa</h2>
                        <p class="descripcion-atraccion">Tiene como objetivo impulsar las actividades culturales y artísticas, así como llevar programas de desarrollo de arte y cultura en esta localidad.</p>
                        <center>
                        <img src="../../img/Reynosa-Parques.jpg" alt="" class="featured__img">
        </center>  
                    </div>
                </div>
            </section>
